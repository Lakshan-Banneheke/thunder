...
```bash
curl -kL -X POST "{{ServerUrl}}/organization-units" \
...
```bash
curl -kL "{{ServerUrl}}/organization-units/{id}" \
  -H 'Authorization: Bearer <access-token>'
```
...
```bash
curl -kL "{{ServerUrl}}/organization-units/tree/{path}" \
  -H 'Authorization: Bearer <access-token>'
```
...
```bash
curl -kL -X PUT "{{ServerUrl}}/organization-units/{id}" \
  -H 'Authorization: Bearer <access-token>' \
  -H 'Content-Type: application/json' \
...
```bash
curl -kL -X PUT "{{ServerUrl}}/organization-units/tree/{path}" \
  -H 'Authorization: Bearer <access-token>' \
  -H 'Content-Type: application/json' \
  -d '{"name": "Engineering Team", "handle": "engineering", "parent": null}'
```
...
```bash
curl -kL "{{ServerUrl}}/organization-units?filter=name%20eq%20%22Engineering%22" \
  -H 'Authorization: Bearer <access-token>'
```
...
```bash
curl -kL "{{ServerUrl}}/organization-units?filter=name%20eq%20%22Engineering%22%20AND%20handle%20eq%20%22engineering%22" \
  -H 'Authorization: Bearer <access-token>'
```
...
```bash
curl -kL "{{ServerUrl}}/organization-units?filter=name%20eq%20%22Engineering%22%20OR%20name%20eq%20%22Sales%22" \
  -H 'Authorization: Bearer <access-token>'
```
...
```bash
curl -kL "{{ServerUrl}}/organization-units/<parent-id>/ous?filter=createdAt%20gt%20%222024-01-01T00:00:00Z%22" \
  -H 'Authorization: Bearer <access-token>'
```
...
```bash
curl -kL "{{ServerUrl}}/organization-units?filter=name%20eq%20%22Engineering%22&limit=10&offset=0" \
  -H 'Authorization: Bearer <access-token>'
```
...
```bash
curl -kL "{{ServerUrl}}/organization-units/{id}/users" \
  -H 'Authorization: Bearer <access-token>'
```
...
```bash
curl -kL "{{ServerUrl}}/organization-units/tree/{path}/users" \
  -H 'Authorization: Bearer <access-token>'
```
...
```bash
curl -kL "{{ServerUrl}}/organization-units/{id}/users?include=display" \
  -H 'Authorization: Bearer <access-token>'
```
...
```bash
curl -kL "{{ServerUrl}}/organization-units/{id}/groups" \
  -H 'Authorization: Bearer <access-token>'
```
...
```bash
curl -kL "{{ServerUrl}}/organization-units/tree/{path}/groups" \
  -H 'Authorization: Bearer <access-token>'
```
...
```bash
curl -kL -X DELETE "{{ServerUrl}}/organization-units/{id}" \
  -H 'Authorization: Bearer <access-token>'
```
...
```bash
curl -kL -X DELETE "{{ServerUrl}}/organization-units/tree/{path}" \
  -H 'Authorization: Bearer <access-token>'
```
