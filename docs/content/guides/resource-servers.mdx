...
```bash
curl -kL -X POST {{ServerUrl}}/resource-servers/<resource-server-id>/actions \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <access-token>' \
  -d '{
    "name": "List Bookings",
...
```bash
curl -kL -X POST {{ServerUrl}}/resource-servers/<resource-server-id>/resources \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <access-token>' \
  -d '{
    "name": "Reservations",
...
```bash
curl -kL -X POST {{ServerUrl}}/resource-servers/<resource-server-id>/resources/<resource-id>/actions \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <access-token>' \
  -d '{
...
```bash
curl -kL {{ServerUrl}}/resource-servers?limit=10&offset=0 \
...
```bash
curl -kL {{ServerUrl}}/resource-servers/<resource-server-id> \
  -H 'Accept: application/json' \
  -H 'Authorization: Bearer <access-token>'
```
...
```bash
curl -kL -X PUT {{ServerUrl}}/resource-servers/<resource-server-id> \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <access-token>' \
  -d '{
    "name": "Booking API v2",
...
```bash
curl -kL -X DELETE {{ServerUrl}}/resource-servers/<resource-server-id> \
  -H 'Authorization: Bearer <access-token>'
```
...
```bash
curl -kL {{ServerUrl}}/resource-servers/<resource-server-id>/resources \
  -H 'Accept: application/json' \
  -H 'Authorization: Bearer <access-token>'
```
...
```bash
curl -kL "{{ServerUrl}}/resource-servers/<resource-server-id>/resources?parentId=<parent-resource-id>" \
  -H 'Accept: application/json' \
  -H 'Authorization: Bearer <access-token>'
```
...
```bash
curl -kL -X PUT {{ServerUrl}}/resource-servers/<resource-server-id>/resources/<resource-id> \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <access-token>' \
  -d '{
...
```bash
curl -kL -X DELETE {{ServerUrl}}/resource-servers/<resource-server-id>/resources/<resource-id> \
  -H 'Authorization: Bearer <access-token>'
```
...
```bash
curl -kL {{ServerUrl}}/resource-servers/<resource-server-id>/actions \
  -H 'Accept: application/json' \
  -H 'Authorization: Bearer <access-token>'
```
...
```bash
curl -kL {{ServerUrl}}/resource-servers/<resource-server-id>/resources/<resource-id>/actions \
  -H 'Accept: application/json' \
  -H 'Authorization: Bearer <access-token>'
```
...
```bash
curl -kL -X PUT {{ServerUrl}}/resource-servers/<resource-server-id>/actions/<action-id> \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <access-token>' \
  -d '{
...
```bash
curl -kL -X DELETE {{ServerUrl}}/resource-servers/<resource-server-id>/actions/<action-id> \
  -H 'Authorization: Bearer <access-token>'
```
