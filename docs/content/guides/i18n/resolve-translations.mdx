...
**Request:**
```bash
curl -X GET {{ServerUrl}}/i18n/languages
```
**Response:**
```json
{
...
**Request:**
```bash
curl -X GET "{{ServerUrl}}/i18n/languages/en-US/translations/resolve"
```

You can also filter by namespace to focus on a specific screen:

```bash
curl -X GET "{{ServerUrl}}/i18n/languages/en-US/translations/resolve?namespace=signin"
```
...
**Request:**
```bash
curl -X GET "{{ServerUrl}}/i18n/languages/es/translations/resolve"
```
...
**Request:**
```bash
curl -X GET "{{ServerUrl}}/i18n/languages/es/translations/resolve?namespace=signin"
```
...
**Request:**
```bash
curl -X GET "{{ServerUrl}}/i18n/languages/es/translations/ns/recovery/keys/forms.username.title/resolve"
```
