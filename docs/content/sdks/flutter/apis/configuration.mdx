...
title: Configuration
docType: reference
description: ThunderIDConfig options for the Flutter SDK, covering client ID, base URL, scopes, and redirect URIs.
---
...
| :--- | :--- | :--- | :--- |
| `baseUrl` | `String` | - | **Required.** Your <ProductName /> instance URL. Must use HTTPS (e.g., `{{ServerUrl}}`). |
