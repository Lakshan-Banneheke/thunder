...
description: Vanilla JavaScript SDK for browser-based authentication using OAuth 2.0 PKCE without a framework.
---
...
To get started quickly, check out our [Vanilla JavaScript Quickstart Guide](../../../getting-started/connect-your-application/browser) for step-by-step instructions.
