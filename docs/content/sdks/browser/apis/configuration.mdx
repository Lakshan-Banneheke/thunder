...
description: Configuration options for the Browser SDK, including client ID, base URL, scopes, and token persistence.
---
...
| `baseUrl` | `string` | Your <ProductName /> instance URL (e.g., `{{ServerUrl}}`) |
