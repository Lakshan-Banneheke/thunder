...
const result = await client.exchangeToken({
  ...
  data: {
    ...
    resource: 'https://api.example.com/app',
  },
  attachToken: true,
  returnsSession: true,
})
