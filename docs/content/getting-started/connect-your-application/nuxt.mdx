...
NUXT_PUBLIC_THUNDERID_BASE_URL={{ServerUrl}}
...
:::info Auto-imports
The `@thunderid/nuxt` module auto-registers all components (e.g. `<SignedIn>`, `<SignInButton>`) and auto-imports all composables. You do **not** need to import them manually.
:::
