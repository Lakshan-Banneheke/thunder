...
title: Try It Out
docType: use-case
description: Issue a verifiable credential from Wayfinder to a real wallet, then verify it at the Skyline Lounge, to see decentralized identity in action with {{ProductName}}.
sidebar_position: 0
---
